...
$cno = $_POST['cno']; // 인자로 들어온 email
$password = $_POST['password']; // 인자로 들어온 비밀번호

// 인자로 들어온 email로 쿼리문을 실행하고 결과를 저장
$sql = "SELECT CNO, NAME, PASSWD FROM CUSTOMER WHERE CNO ='{$cno}'";
