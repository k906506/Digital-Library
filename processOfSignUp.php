...
$sqlFindPk = "SELECT * FROM USER_ACCOUNT_INFO WHERE EMAIL = '{$_POST['email']}'"; // 입력한 EMAIL이 이미 사용 중인지 검색
...
$sql = "INSERT INTO USER_ACCOUNT_INFO (CNAME, PHONENUMBER, EMAIL, PASSWORD) VALUES ('{$_POST['name']}', '{$_POST['phoneNumber']}', '{$_POST['email']}', '{$_POST['password']}')";
